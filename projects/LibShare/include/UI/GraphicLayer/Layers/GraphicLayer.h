...
//----坐标转换-------------------------------------
    ...
    */
    ...
    static void MapPointToLayer(const GraphicLayer * pLayerSrc, const GraphicLayer * pLayerDst, POINT * pPt, size_t nCount = 1);
...
//----xml属性配置-----------------------------------------------------
    ...
    */
    bool LoadFromXml(const wchar_t * pFilePath, pugi::xml_encoding encoding = pugi::xml_encoding::encoding_auto);
    bool LoadFromXml(const void * pBuffer, size_t nSize, pugi::xml_encoding encoding = pugi::xml_encoding::encoding_auto);
...
*/
    ...
    bool SaveToXml(const wchar_t * pFilePath, pugi::xml_encoding encoding = pugi::xml_encoding::encoding_auto);
    ...
    //动态创建辅助函数: 类信息注册
    static void RegisterLayerClassesInfo(const wchar_t * pCreateKay, TRuntimeCreateFunction pfnCreateFunc);
