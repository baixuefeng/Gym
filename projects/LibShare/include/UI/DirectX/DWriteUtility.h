...
struct TDWriteTextAttributes
{
    ...
    // 文本垂直对齐方式
    DWRITE_PARAGRAPH_ALIGNMENT m_textParagraphAlignment = DWRITE_PARAGRAPH_ALIGNMENT::DWRITE_PARAGRAPH_ALIGNMENT_NEAR;
...
public:
    ...
    */
    HRESULT CreateCustomDWriteFontCollection(
    ...
    */
    HRESULT CreateCustomDWriteFontCollection(
        const std::vector<std::wstring> & fontPath,
        IDWriteFontCollection ** ppCustomCollection);
    ...
    */
    HRESULT CreateCustomDWriteFontCollection(
        std::initializer_list<const wchar_t *> fontList,
        IDWriteFontCollection ** ppCustomCollection);
    ...
    */
    ...
    @return 字体信息
    */
    static ATL::CComPtr<IDWriteFont> GetFontFromTextFormat(ATL::CComPtr<IDWriteTextFormat> spTextFormat);
