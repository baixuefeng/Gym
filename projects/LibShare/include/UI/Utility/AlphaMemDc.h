...
//--------------------------------------------------
class AlphaMemDc : public WTL::CDC
{
...
public:
    ...
    */
    ...
    @return 操作是否成功
    */
    bool StretchBltDraw(HDC hDestDc,
                        const RECT *pDest = nullptr,
                        const RECT *pSrc = nullptr,
                        DWORD dwRop = SRCCOPY);
    ...
    */
    ...
    @return 位图句柄
    */
    static HBITMAP CreateAlphaBitmap(HDC hDc,
                                     int32_t nWidth,
                                     int32_t nHeight,
