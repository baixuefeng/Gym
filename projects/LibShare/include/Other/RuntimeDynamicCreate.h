...
//注册函数的函数原型
using TRegisterClassFunction = void (*)(const wchar_t *pCreateKay,
...
public:                                                                                            \
    virtual const wchar_t *GetCreateKey() { return pCreateKey; }                                   \
    static const wchar_t *GetMyCreateKey() { return pCreateKey; }                                  \
...
#define IMPLEMENT_RUNTIME_DYNAMIC_CREATE(className, RegisterFunc)                                  \
    ...
    {                                                                                              \
        (RegisterFunc)(className::GetMyCreateKey(),                                                \
                       (TRuntimeCreateFunction)&className::CreateObject);                          \
    }                                                                                              \
