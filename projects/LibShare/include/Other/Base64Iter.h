...
using Base64EncodeIter =
    boost::archive::iterators::base64_from_binary<boost::archive::iterators::transform_width<
        InputIter,
        6,
...
//base64解码迭代器
template<class InputIter>
using Base64DecodeIter = boost::archive::iterators::transform_width<
