...
bool AlphaMemDc::AlphaDraw(HDC hDestDc, const RECT* pDest /*= nullptr*/, const RECT * pSrc /*= nullptr*/, uint8_t alpha /*= 255*/, bool bSrcAlpha /*= true*/)
{
    if (!IsNull() && hDestDc)
    {
...
bool AlphaMemDc::BitBltDraw(HDC hDestDc, const RECT* pDest /*= nullptr*/, const RECT * pSrc /*= nullptr*/, DWORD dwRop /*= SRCCOPY*/)
{
    if (!IsNull() && hDestDc)
    {
        return !!::BitBlt(
...
bool AlphaMemDc::StretchBltDraw(HDC hDestDc, const RECT* pDest /*= nullptr*/, const RECT * pSrc /*= nullptr*/, DWORD dwRop /*= SRCCOPY*/)
{
    if (!IsNull() && hDestDc)
    {
        return !!::StretchBlt(
...
HBITMAP AlphaMemDc::CreateAlphaBitmap(HDC hDc, int32_t nWidth, int32_t nHeight, void ** ppBitmapData/* = nullptr*/)
{
